...
const sections = [
  ...
  {
    title: "届けたい相手",
    body: "新人の方や、中堅になって一通り任されることが増えてきた方が、困ったときに少しでも早く前に進めるように。さっと引いて確認でき、必要なときはもう一段深くまで追えるような場所にできればと思っています。",
  },
  {
    title: "お問い合わせ・ソースコード",
    body: "記事の誤りや改善のご提案は、お問い合わせページからお寄せください。",
  },
  {
    title: "運営者",
    body: "運営者：dev-craft 管理人（Yuji Nakamura）。クレジットカード決済や銀行振込など決済・金融系を中心に、業務システムの開発・保守に 28 年ほど携わってきました。役割は開発からチームリーダー、障害対応、インフラの運用保守まで。言語は Java を軸に、C 系からスクリプト系まで一通り使ってきました。記事はそうした現場で実際に扱った処理を出発点にしています。",
  },
]
